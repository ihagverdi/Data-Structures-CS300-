...
void prompt(BinarySearchTree<Contact>& BST, HashTable& HashTable) {
	...
	do {
		...
		case 3: {
			...
			cout << endl << endl;
			cout << "Deletion from the Binary Tree took " << BSTTime.count() << " nanoseconds. . ." << endl;
			cout << "Deletion from the HashTable took " << HTTime.count() << " nanoseconds. . ." << endl;
			cout << endl << endl;
			break;
		}
		case 4: {
...
void run() {
	...
	HashTable myHashTable(INITIAL_TABLE_SIZE, 0.8);
